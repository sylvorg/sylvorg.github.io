...
with import (fetchTarball {
    url = "https://github.com/<<username>>/nixpkgs/archive/d5b8a4f80bf731183ee32a0357c1313cfd8c29e5.tar.gz";
    sha256 = "1fd665gz0h9sldsy683f1kvlgngv2sx79myb3v7r2hmsf0lbl8cg";
}) {}; mkShell {
    buildInputs = [ yadm git ];
    shellHook = ''
#+end_src

#+begin_src shell
yadm clone --no-bootstrap https://github.com/<<username>>/<<username>>.git 2> /dev/null
GIT_SSL_NO_VERIFY=1 git -C ~/.local/share/yadm/repo.git --work-tree ~ submodule update --init --depth 1 --recursive --remote --force
